...
DEFAULT_WATERMARK = "🌿 ᴘᴏᴡᴇʀᴇᴅ ʙʏ : <a href='https://t.me/NeonGhost_Network'>『 𝙉𝙚𝙤𝙣𝙂𝙝𝙤𝙨𝙩_𝙉𝙚𝙩𝙬𝙤𝙧𝙠 』</a>𓆩ꨄ︎𓆪"
...
async def start_post_session(client: Client, message: Message, user_id: int, movie_name: str):
    ...
    if USE_GETFILE_BUTTON_BY_DEFAULT:
        ...
        post_sessions[user_id]["buttons"] = [  
            ...
            [InlineKeyboardButton('♻️ ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ♻️', url="https://t.me/MOVIE_REQUESTX/56553?single")],  
            [InlineKeyboardButton('🔰 ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ 🔰', url="https://t.me/MOVIE_REQUESTX")]  
        ]
